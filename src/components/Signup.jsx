        ...
        <div className="signup w-[40%] flex flex-col items-start justify-center">
          ...
          <div className="flex flex-col mt-10 gap-10">
            ...
            <input
              ...
              <button type="submit" className="bg-[#DB4444] py-3">
             <span>Create Account</span>
            </button>
            <button className="flex items-center justify-center w-96 border-2 border-gray-500 bg-transparent rounded-md py-3 text-sm font-medium">
              <svg
            ...
            <p className="text-gray-500">Already have account? <a href="" className="underline text-gray-500">Log in</a></p>
              </div>
          </div>
        </div>
      </div>
